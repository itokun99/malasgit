...
| `` e `` | Edytuj | Otwórz plik w zewnętrznym edytorze. |
| `` <ctrl+t> `` | Otwórz zewnętrzne narzędzie różnic (git difftool) |  |
| `` <space> `` | Przełącz plik włączony w łatkę | Przełącz, czy plik jest włączony w niestandardową łatkę. Zobacz https://github.com/itokun99/malasgit#rebase-magic-custom-patches. |
| `` a `` | Przełącz wszystkie pliki | Dodaj/usuń wszystkie pliki commita do niestandardowej łatki. Zobacz https://github.com/itokun99/malasgit#rebase-magic-custom-patches. |
