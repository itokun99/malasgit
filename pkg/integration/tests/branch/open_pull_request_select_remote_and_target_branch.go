...
var OpenPullRequestSelectRemoteAndTargetBranch = NewIntegrationTest(NewIntegrationTestArgs{
	...
	SetupRepo: func(shell *Shell) {
		...
		shell.RunCommand([]string{"git", "remote", "set-url", "origin", "https://github.com/my-personal-fork/malasgit"})
		shell.RunCommand([]string{"git", "remote", "set-url", "upstream", "https://github.com/itokun99/malasgit"})
	},
	Run: func(t *TestDriver, keys config.KeybindingConfig) {
		...
		t.FileSystem().FileContent(
			"/tmp/openlink",
			Equals("https://github.com/my-personal-fork/malasgit/compare/master...branch-2?expand=1\n"))
	},
})
