...
var BareRepo = NewIntegrationTest(NewIntegrationTestArgs{
	Description:  "Open malasgit in the worktree of a bare repo and do a rebase/bisect",
	ExtraCmdArgs: []string{},
	Skip:         false,
	...
	SetupRepo: func(shell *Shell) {
		...
		// directory that all malasgit tests start in
		...
		// This is the dir we were just in (and the dir that malasgit starts in when the test runs)
