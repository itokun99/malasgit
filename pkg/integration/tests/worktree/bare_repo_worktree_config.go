...
// that it invokes malasgit with $GIT_DIR set but not
...
var BareRepoWorktreeConfig = NewIntegrationTest(NewIntegrationTestArgs{
	Description:  "Open malasgit in the worktree of a vcsh-style bare repo and add a file and commit",
	...
	SetupRepo: func(shell *Shell) {
		...
		//
		//
		// 'repo' is the repository/directory that all malasgit tests start in
