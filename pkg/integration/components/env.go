...
const (
	// These values will be passed to malasgit
	LAZYGIT_ROOT_DIR          = "LAZYGIT_ROOT_DIR"
	SANDBOX_ENV_VAR           = "SANDBOX"
	TEST_NAME_ENV_VAR         = "TEST_NAME"
	WAIT_FOR_DEBUGGER_ENV_VAR = "WAIT_FOR_DEBUGGER"

	// These values will be passed to both malasgit and shell commands
	...
	// These values will be passed through to malasgit and shell commands, with their
...
// Having such a minimal list ensures that malasgit behaves the same across different test environments.
