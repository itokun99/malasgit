...
// but you can also run the commands from within malasgit to emulate things happening
// in the background.
type Shell struct {
...
// Help files are located at test/files from the root the malasgit repo.
